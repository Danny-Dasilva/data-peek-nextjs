...
import type { AIProvider, AIMultiProviderConfig, AIProviderConfig } from '@data-peek/shared'
import { AI_PROVIDERS } from '@data-peek/shared'
...
export function AISettingsModal({
  ...
  const handleValidate = async () => {
    ...
    try {
      const result = await api.ai.validateKey({
