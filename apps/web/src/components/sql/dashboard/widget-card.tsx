...
import { Card, CardContent, CardHeader, CardTitle } from '@/components/sql/ui/card'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function WidgetCard({ widget, dashboardId, editMode, connectionConfig }: WidgetCardProps) {
  ...
  const handleRefresh = () => {
    if (connectionConfig) {
      refreshWidget(widget, connectionConfig)
    }
  }
      ...
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <div className="flex items-center gap-1">
          <Button
            ...
            disabled={isLoading || !connectionConfig}
          >
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={handleRefresh} disabled={!connectionConfig}>
